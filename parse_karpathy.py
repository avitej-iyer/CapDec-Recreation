...
kagle_json = './dataset_flickr30k.json'
new_json_train = 'post_processed_karpthy_flickr/train.json'
new_json_test = 'post_processed_karpthy_flickr/test.json'
new_json_val = 'post_processed_karpthy_flickr/val.json'
